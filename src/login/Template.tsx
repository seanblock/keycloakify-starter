...
import clerkXpressLogoPngUrl from "./assets/clerkxpress-logo.png";
...
export default function Template(props: TemplateProps<KcContext, I18n>) {
  ...
  return (
    <div className={"my-root-form-container"}>

      {/* Left Side */}
      <div id="kc-header" className="my-root-form-left">
        <div
          id="kc-header-wrapper"
          className="my-root-company-text-wrapper"
          style={{ fontFamily: '"Work Sans"' }}
        >
            {/* Replace with dog image */}
          {/* <img src={clerkXpressLogoPngUrl} alt="ClerkXpress logo" width={50} />
          <span className="my-root-company-text">{msg("loginTitleHtml", "ClerkXpress")}</span> */}
        </div>
      </div>

      {/* Right Side */}
      <div
        className={"my-root-form-right"}
      >
         <div
          id="kc-header-wrapper"
          className="my-root-company-text-wrapper"
